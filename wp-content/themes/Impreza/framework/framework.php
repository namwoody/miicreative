...
// TODO Replace with own light-weight implementation
define( 'RWMB_URL', trailingslashit( $us_template_directory_uri . '/framework/vendor/meta-box' ) );
define( 'RWMB_DIR', trailingslashit( $us_template_directory . '/framework/vendor/meta-box' ) );
