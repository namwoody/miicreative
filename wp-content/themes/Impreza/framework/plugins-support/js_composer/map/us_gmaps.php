...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'description' => sprintf( __( 'Enter JSON code for styling the map. You can find good examples at %s.', 'us' ), '<a href="https://snazzymaps.com/" target="_blank">snazzymaps.com</a>' ),
			'type' => 'textarea_raw_html',
